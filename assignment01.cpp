...
main()
{
    //1. Write a program scan year and print year is leap or Not.
    int year;
    cout << "Enter Year:";
    cin >> year;
    if (year % 4 == 0)
    ...
    /*
    2.Write a program scan number between 1 to 700
    and print
    ...
    */
    ...
    /*
    3.Write a program scan age of person
    ...
    */
    ...
    /*
    4.Write program which print bill
